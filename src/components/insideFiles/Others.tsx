  ...
  useEffect(() => {
    ...
    const fetchFiles = async () => {
        try {
          ...
          const data = await response.json();
          const files = data.files.filter((file: { file_type: string; }) => file.file_type !== 'mp3' &&  file.file_type !== 'mp4' && file.file_type !== 'pdf' && file.file_type !== 'docx' && file.file_type !== 'pdf' && file.file_type !== 'png' && file.file_type !== 'jpg' && file.file_type !== 'jpeg' && file.file_type !== 'txt' );
